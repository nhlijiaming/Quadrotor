//---------------------------------------------------------
/*	file name:oled.c
 *  describe :define the function for oled
 *  created time: 8月12日
 *
 */
...
const byte F14x16[] = {
		...
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,//一0
		0x04,0xF4,0x04,0xFC,0x00,0x40,0x64,0x54,0x4E,0x54,0x64,0xC4,0x40,0x00,
		0x08,0x09,0x45,0x41,0x3F,0x00,0x1F,0x09,0x09,0x4F,0x40,0x7F,0x00,0x00,//骑1
		0x20,0x38,0xA6,0x60,0x18,0x20,0xD0,0x4E,0x48,0xC8,0x68,0x58,0xC0,0x00,
		0x22,0x23,0x22,0x12,0x12,0x00,0x3F,0x44,0x44,0x47,0x44,0x44,0x77,0x00,//绝2
		0x40,0x20,0x10,0x0C,0x00,0x00,0x7E,0x00,0x00,0x04,0x08,0x10,0x60,0x00,
		0x40,0x44,0x44,0x44,0x44,0x44,0x7F,0x44,0x44,0x44,0x44,0x44,0x40,0x00,//尘3
};
...
void OLED_WrDat(unsigned char data)
{
	...
	//OLED_CS=0;;
	OLED_DS_H;
//	SysCtlDelay(SysCtlClockGet()/15000000);
...
void OLED_Init(void)
{
	...
	GPIOPadConfigSet(GPIO_PORTD_BASE, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, GPIO_STRENGTH_2MA,GPIO_PIN_TYPE_STD);     //上拉输出
	OLED_D0_H;
	OLED_D1_H;
	OLED_DS_H;
	OLED_RST_H;
...
void OLED_Rectangle(byte x1,byte y1,byte x2,byte y2,byte gif)
{
	...
	for(n=x1;n<=x2;n++)
	{
		...
		if(gif == 1) 	SysCtlDelay(SysCtlClockGet()/600);
	}
